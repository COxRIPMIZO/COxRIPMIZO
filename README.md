...
I am a Software Developer specializing in building high-performance, secure, and scalable enterprise applications. My transition from industrial hardware integration and WinForms to modern distributed web systems has given me a unique, hardware-to-cloud perspective on software architecture.
...
- 🎨 **MudBlazor UI:** Migrating backend cryptographic tools to a modern, dark-mode SaaS dashboard.
- ⚙️ **Performance Tuning:** Writing raw Dapper queries and Stored Procedures for sub-millisecond database reads.
